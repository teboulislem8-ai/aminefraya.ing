...
export default function DashboardPage(){
  ...
  const publishPost=async()=>{
    if(!postText.trim()){showToast('اكتب محتوى المنشور');return}
    await createPost({client_id:postClient,type:postType,content:postText,media_label:null})
    setPostText('');const {data}=await getPosts();if(data)setPosts(data);showToast('تم نشر المنشور ✓')
  }
        ...
        <div style={{flex:1,padding:'1.5rem',overflowY:'auto'}}>
            ...
            <div>
              ...
              <div style={B}>
                ...
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:8}}>
                  ...
                  <button onClick={publishPost} style={{...BSave}}>نشر</button>
                </div>
              </div>
          ...
          {panel==='articles'&&(
            <div>
              ...
              {articles.map(a=>{const cs=CAT_STYLES[a.category]||{bg:'#F1EFE8',c:'#5F5E5A'};return(
